...
def _translation_prompt(title: str, body: str) -> str:
    ...
    return (
        ...
        "the source text. "
        "Do not use markdown formatting in the translation - no **bold**, no *italic*/*emphasis*, no "
        "_underline_, no backticks, no # headings. If the English source uses asterisks or underscores for "
        "emphasis, drop them and just translate the plain words - the destination does not render markdown, "
        "so those characters would show up as literal punctuation in the published Kannada post."
